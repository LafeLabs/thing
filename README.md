...
- A Channel Address.  Each Geometron instance has a string of random(by dice roll) letters and numbers that can be used to track the information stream using hashtags on commercial platforms like Twitter and Instagram without fixed centralized accounts.

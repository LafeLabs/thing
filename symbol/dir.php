...
if(isset($_GET["type"])){
    if($_GET["type"] == "dir"){
        ...
        foreach($files as $value){
            if($value{0} != "." && is_dir($value) && $value != "php" && $value != "jscode" && $value != "data" && $value != "html" && $value != "css" && $value != "shapetables" && $value != "fonts" && $value != "icons" && $value != "symbolfeed" && $value != "uploadimages"){

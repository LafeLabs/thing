...
if(isset($_GET["type"])){
    if($_GET["type"] == "dir"){
        ...
        foreach($files as $value){
            if($value{0} != "." && is_dir($value) && $value != "php" && $value != "jscode" && $value != "data" && $value != "html" && $value != "symbols" && $value != "fonts" && $value != "icons" && $value != "iconsymbols" && $value != "uploadimages" && $value != "symbol" && $value != "symbolfeed"){
